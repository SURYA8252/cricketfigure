...
public class SwaggerConfig {
    ...
    private ApiInfo getInfo() {
    	return new ApiInfo("Cricket : Backend", "This Project develop to only for backend ", "1.0", "Terms of Service", new Contact("Surya", "https://techwarezen.com/", "hr@techwarezen.com"), "License of APIs", "API license URL",Collections.emptyList());
    }
}
